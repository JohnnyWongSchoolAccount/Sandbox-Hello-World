...
void UIpageText(String textPort, String textPortAlt, String textPortWeather) {
  if (ONOFF_MUSICPLAYER) {
    drawText( height, purpInk, CENTER, CENTER, Font, textSpace+textSpace+textSpace+textPortAlt+textSpace+textSpace+textSpace, musicX1, musicY1, musicWidth, musicHeight);
    drawText( height, purpInk, CENTER, CENTER, Font, textSpace+textSpace+textPortWeather+textSpace+textSpace, weatherAppX1, weatherAppY1, weatherAppWidth, weatherAppHeight);
    ...
    drawText( height, purpInk, CENTER, CENTER, Font, textSpace+textSpace+textSpace+textPortAlt+textSpace+textSpace+textSpace, weatherAppX1, weatherAppY1, weatherAppWidth, weatherAppHeight);
  } else {
    drawText( height, purpInk, CENTER, CENTER, Font, textSpace+textPort+textSpace, musicX1, musicY1, musicWidth, musicHeight);
    drawText( height, purpInk, CENTER, CENTER, Font, textSpace+textSpace+textPortWeather+textSpace+textSpace, weatherAppX1, weatherAppY1, weatherAppWidth, weatherAppHeight);
  }
